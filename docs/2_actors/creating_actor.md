...
| Youth    |       PAMS       |     2      |   3Bd    |     1Rd      |      0       |
| Prime    |       PAMS       |     2      |   3Bd    |     1Rd      |      0       |
...
> or Veteran = 0 + 1Bd {4} + -1 (fixed) from Physical/Agility, 2Rd {4,1}
> No gain, -1pt from physical or agility, plus a -1 pt from either Mental or Social
...
- Scars are negatives events which haunt a person, perhaps a fear or phobia, or a memory of situation with great consequence or impact to that person. A **Scar** **will contribute nRd resistance penalties** to tests which would trigger the actor's scar

- Strength is the positive consequence of events or dramatic situations, the experience of which will positive impact future interactions of this nature. A **Strength** **will contribute  nBd base dice** in situations which benefit from the actor's strength.
...
## G. Advance the Actor Level if appropriate
[TODO]
...
### Example Skill Lists - Late Medieval
...
The starting value of 4 + the successes from a pool of double the Physical attribute as Bd + 2Dd

[OLD VERSION The starting value of 5 + the successes from a pool of 3Bd + 3Rd + Physical as Dd]

> E.g. 4 + two Physical 4Bd {5,3,3,2} = 1 + 2Dd {6,4,1} = 1 for a total of 2 which equals a total of 6 Flesh

## B. Grit Currency Pool
The starting value of 4 + the successes from a pool of double the Agility attribute as Bd + 2Dd

## C. Fortitude Currency Pool
The starting value of 4 + the successes from a pool of Mental + Social attributes as Bd + 2Dd

## D. Composure Pool
The starting value of 4 + the successes from a pool of the number of Bonds + Social as Bd + 2Dd

> E.g. 4 + three bonds + Social of three for 6Bd {6,6,5,3,2,1} = 3 success + 2Dd {5,2} = 2 successes which equals a total of 9 Composure
