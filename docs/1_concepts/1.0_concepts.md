...
### Marginal Success
When the outcome is one net success, a marginal success is achieved. This is a "Yes, But..." outcome, where an additional price can be paid to convert to a success. The price should be meaningful.

> E.g. An Actor getting a marginal success while negotiating a trade deal, pays the price in frustration, paying 2 points of composure

[TODO] - temporary penalties not meaning enough in most circumstances.
