...
- number of successes
- plus weapon modifier dependent on the width of the lowest, widest number

|Weapon Type | Requirements | Outcome |
| :--- | :--- | :--- |
| Light | Quad (4+)| +1 success |
| Mid | Trip (3+) | +1 success |
| Heavy | Trip (3+) | +2 successes |
| Very Heavy | Double (2+) | +2 successes |

> Example
> ![[Pasted image 20231014184301.png]]
> 10 Bd vs 6Rd = 1 success
> lowest, widest number is 5
> firing a light caliber weapon needs a quad to gain a benefit, since there are 4 x 5's a bonus of +1 success is added
> Inflicting a 2pt wound

- Alt

|Weapon Type | For Each | Outcome |
| :--- | :--- | :--- |
| Light | n/a | n/a |
| Mid | Quad (4+) | +1 success |
| Heavy | Trip (3+) | +1 success |
| Very Heavy | Trip (3+) | +2 successes |

E.g.
- Mid weapon with one quad, gets +1
- Heavy weapon with two trips, gets +2

#### Damage
- Fill the max damage spaces
- If there isn't a slot, move up to the higher level
#### Downed
- If all damage slots are full, but no overage taken = downed
- if a 3+ wound take = downed
- If all damage is taken and downed = dead

#### Overflow damage
- 4+ = Downed
- all successes/damage need to be taken
- 3pt wound break/bleeding etc
- Surviving damage
	- Min (3) Flesh status is 3/2/1 = 6
	- (4) is 7
	- (5) is 9
	- (6) is 12

#### Knockdown
- Winner's Knockdown is successes (damage before armor) + Physical 
	- 1 success + 4 Physical = 5
- Compare with highest of defenders Phy or Agl
	- Highest = 4
- If greater then defender knocked back and disadvantaged into next round 2Rd
	- 5 vs 4 = disadvantaged
- If equal or greater than Phy + Agl combined = knockdown & double disadvantage = 4Rd
	- 5 vs 4+3 not no additional effect
- Stance could modify knockdown value by +2/-2
	- Press attack winner adds +2 to their knockdown
		- 1 + 4 + 2 = 7
	- Press attack loser reduces their knockdown defense by 2
		- Physical 4-2 = 2 for knockback
		- Physical 4-2 + 3 Agility = 5 for knockdown
	- Brace winner reduces their knockdown by 2
		- 1 + 4 - 2 = 3 for knockdown
	- Brace loser increases their knockdown defense 2
		- 4 + 2 for defense
...
Considerations;
- Max damage to cap run away successes
	- based on weapon?
	- is there a need to cap... no
		- Min (3) Flesh status is 3/2/1 = 6
		- (4) is 7
		- (5) is 9
		- (6) is 12
- Overflow damage
	- 4+ = Downed
	- all successes need to be taken
	- If all take and downed = dead
	- 3pt wound break/bleeding etc
- Use of Luck?
	- Take a 3pt to cover 2pt? simpler logic...
	- 
...
- Multiple opponents?
	- Simple splitting of attack pools feels too narrow
	- Subsequent actions
		- 4Rd/6Rd for up to 2 actions



- Cast/Cameo Flesh pools
	- 2/1 or 3/2/1
