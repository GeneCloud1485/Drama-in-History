...
#### Flesh Wounds
Calculate the size of the wound, reduce by any Armor stoppage and then reduce the Flesh pool. Record the wound and deal with Knock-down and courage test.
...
Unarmed or Improvised

Fist, Tankard, Hilt of Dagger
...
Lost grit is recovered with a short period of resting (~an hour). Grit is recovered with an hour of rest. The recovery takes current Grit to 'max Grit - current penalty dice’ this does not include the Agility specific penalty dice for having 0 Grit.. If no penalty dice then grit is fully restored in an hour, if rest is interrupted then grit is recovered pro-rata.

When aging penalty dice exist, each final point of Grit takes 1 day to recover.

_E.g. After a skirmish a wounded man-at-arms sits to recover his lost Grit. He has lost all of his Grit and has been lucky to only incur the 1 penalty dice for the loss of Grit and avoided anything more than a light 1pt Flesh wound. He recovers his Grit up to 9 (max 10 - 1 penalty die) over the course of the hour resting._

_Or bruised and tired he catches his breath in a lull of the battle, before the next onslaught. He currently has 2 penalty dice, a current Grit of 2 from a max Grit of 10. He is only able to grab half an hour, so recovers 1/2 of the potential recovery = 4 points (half of 10-2)_

**Critical Results**

A critical result is triggered when 3+ sixes are rolled on the positive (base + advantage/risk dice) pools. 

  

**On a critical result;**

-   For the winner of an opposed roll;

-   As many net 6s as were rolled are added in additional Flesh damage to the target in addition to normal damage results. This damage can be blocked by defensive harness, and reduced by Critical Failures
-   If at least 1 point of damage is taken to Flesh through armor, the wound it treated as a major Critical Wound. This will trigger a level TN2 Courage test.
-   If the winner also rolls 3+ ones in the negative dice pool (advantage/risk + penalty) then the results are combined, effectively reducing the impact of the Critical Result.
-   Critical results are always considered as solid hits, as if the result of the successes were even.

-   For the loser of an opposed roll;

-   The loser also hits the winner and deals the number of sixes as flesh damage. This damage is reduced by defensive harness and is net of any Critical Failure results.
-   If any Flesh damage is dealt, the wound is considered a Critical Wound and a courage test is required.
